...
def import_xes(filename: str):
    ...
    if not failed_rows.empty:
        ...
        failed_rows[['original_timestamp', 'converted_timestamp']].to_csv("/Users/yachi/Desktop/FAIL_helptimestamp_conversion.csv", index=False)
        print(f"Failed conversions saved to 'FAIL_helptimestamp_conversion.csv' for review.")
    else:
    ...
    log[['original_timestamp', 'converted_timestamp']].to_csv("/Users/yachi/Desktop/helpdesk-finalconversion.csv", index=False)
...
def create_prefix_nextevent_pairs(df, max_prefix_length=14, case_id='case:concept:name', activity_id='concept:name'):
    X, y = [], []
...
filename = '/Users/yachi/Desktop/Helpdesk.xes'
...
# Save to Excel
output_path = '/Users/yachi/Desktop/HELPDESK1703!.xlsx'
results_df.to_excel(output_path, index=False)

sorted_log.to_csv("/Users/yachi/Desktop/helpdesk_log_file.csv")